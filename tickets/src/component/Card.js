   ...
   firebase
    ...
    const buy = async () => {
      ...
      const tx = await new TransferTransaction()
        .addTokenTransfer(props.K.TokenId, Acc, -Numb)
        .addTokenTransfer(props.K.TokenId, H, Numb)
        .freezeWith(client);
      ...
      const txn = await new TransferTransaction()
        .addHbarTransfer(Acc, Numb * props.K.Price)
        .addHbarTransfer(H, -(Numb * props.K.Price))
